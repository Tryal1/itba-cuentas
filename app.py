...
def generar_data():
    ...
    try:
        ...
        # se obtienen los campos del formulario y se transforman en lowercase
        ...
        # se crea un objeto Cliente, con los datos del usuario
        registro = Cliente(nombre, apellido, dni, tipo_cuenta, direccion_calle, direccion_numero, direccion_ciudad, direccion_provincia, direccion_pais)

        # se guarda el objeto en un arcihvo json y en otro csv
